...
(1,'examform','2021-04-07','2021-04-20'),
(2,'result','2021-05-01','2021-05-03'),
(3,'recheck','2021-05-01','2021-05-19'),
(4,'admissionform','2021-05-06','2021-05-20');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mohsin`@`%` SQL SECURITY DEFINER VIEW `getconfig` AS select `config`.`id` AS `id`,if((curdate() between `config`.`startdate` and `config`.`enddate`),'1','0') AS `isenable`,`config`.`configname` AS `configname` from `config` */;
