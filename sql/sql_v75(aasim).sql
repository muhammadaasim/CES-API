...
(27,1,2021,1,1,3,NULL,'1620160486577','http://localhost:4000/uploads/navttc.jpg'),
(28,5,2021,1,0,3,NULL,'1620162473157','http://localhost:4000/uploads/navttc.jpg'),
(29,5,2021,2,0,3,NULL,'1620198953316','http://localhost:4000/uploads/navttc.jpg'),
(30,5,2021,1,1,3,NULL,'1620201682404','http://localhost:4000/uploads/navttc.jpg'),
(31,5,2021,1,1,3,NULL,'1620203250240','http://localhost:4000/uploads/navttc.jpg');
...
(5,1,4,1,1,0,4,'1620138029207',0,48,48,'Approved By Controller'),
...
(68,1,1,1,27,30,4,'1620160562634',20,49,99,'Approved By Controller'),
(69,5,6,1,28,30,4,'1620162560629',20,50,60,'Approved By Controller'),
(70,5,1,1,28,10,4,'1620162575013',10,10,60,'Approved By Controller'),
(71,5,2,1,28,0,4,'1620162584410',0,10,60,'Approved By Controller'),
(72,5,4,1,28,0,4,'1620162603061',0,20,30,'Approved By Controller'),
(73,5,5,1,28,10,4,'1620162612386',10,30,60,'Approved By Controller'),
(74,5,3,1,28,10,4,'1620162624084',10,10,60,'Approved By Controller'),
(75,5,7,1,29,30,4,'1620199049374',20,50,100,'Approved By Controller'),
(76,5,8,1,29,30,4,'1620199058547',20,50,100,'Approved By Controller'),
(77,5,9,1,29,30,4,'1620199066717',20,50,100,'Approved By Controller'),
(78,5,5,1,30,30,4,'1620201759591',20,30,70,'Approved By Controller'),
(79,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL),
(80,5,6,1,31,30,4,'1620203488896',20,37,80,'Approved By Controller'),
(81,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `marksheet_tbl` (
  ...
  `gen` varchar(5) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `dept_id` int NOT NULL DEFAULT '0',
  `form_type` varchar(8) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `dept` varchar(50) DEFAULT NULL,
  `status` int DEFAULT NULL,
  `fathername` varchar(40) DEFAULT NULL,
  `prog_id` int NOT NULL DEFAULT '0',
  `program` varchar(30) DEFAULT NULL,
  `programfullname` varchar(30) DEFAULT NULL,
  `credit_hour` int DEFAULT NULL,
  `course_code` varchar(30) DEFAULT NULL,
  `sem_id` int NOT NULL DEFAULT '0',
  `form_id` int NOT NULL DEFAULT '0',
  `subj_id` int NOT NULL DEFAULT '0',
  `subj_name` varchar(40) DEFAULT NULL,
  `sub_type` int NOT NULL,
  `obt_marks` bigint DEFAULT NULL,
  `gp` double(22,2) DEFAULT NULL,
...
/*Data for the table `marksheet_tbl` */

insert  into `marksheet_tbl`(`std_id`,`rollno`,`fullname`,`session`,`semester`,`gen`,`dept_id`,`form_type`,`dept`,`status`,`fathername`,`prog_id`,`program`,`programfullname`,`credit_hour`,`course_code`,`sem_id`,`form_id`,`subj_id`,`subj_name`,`sub_type`,`obt_marks`,`gp`,`grade`,`remarks`,`id`) values 
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,1,'Programming Fundamentals(TH)',0,99,4.00,'A','PASS',1),
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,2,'Programming Fundamentals(PR)',1,40,3.50,'B','PASS',2),
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,3,'ITC (TH)',0,80,3.50,'B','PASS',3),
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,4,'ITC ( PR)',1,48,4.00,'A','PASS',4),
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,5,'ENglish',0,90,4.00,'A','PASS',5),
(1,'21-BSCS-1','Maheen',2021,'First','Miss.',1,'Fresh','Computer Science',4,'nazeer hussain',1,'BSCS','Computer Science',3,'1.1',1,1,6,'E.Maths',0,80,3.50,'B','PASS',6);
...
(1,1,5,'Approve By Teacher',5,0,0,35,35,0,0,48,48);
...
(1,'21-BSCS-1','Maheen',1,2,'chandio','20020-02-02','islam',2,'pakistan','maheen','maheen','shikarpur','shikarpur','nazeer hussain','1620137005251',0,'http://localhost:4000/uploads/navttc.jpg'),
...
(3,'21-BBA-1','yasir',3,18,'soomro','2012-02-22','islam',1,'pakistan','yasir','yasir','shikarpur','shikarpur','yasir','1620141032859',0,'http://localhost:4000/uploads/navttc.jpg'),
(4,'21-BBA-2','yameen',3,24,'sheikh','2222-02-22','islam',1,'pakistan','yameen','yameen','shikarpur','shikarpur','yaseen','1620149203526',0,'http://localhost:4000/uploads/navttc.jpg'),
(5,'21-BSCS-2','Farhan',1,3,'syed','2222-02-22','islam',1,'pakistan','farhan','farhan','shikarpur','shiikarpur','IDK','1620162425107',0,'http://localhost:4000/uploads/navttc.jpg');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mohsin`@`%` SQL SECURITY DEFINER VIEW `getsubjmarks` AS select `std`.`id` AS `std_id`,`std`.`rollno` AS `rollno`,`std`.`gender` AS `gender`,`std`.`fullname` AS `fullname`,`ef`.`session` AS `session`,`std`.`fathername` AS `fathername`,`sm`.`id` AS `sem_id`,`sm`.`name` AS `semester`,`p`.`id` AS `prog_id`,`p`.`name` AS `program`,`p`.`fullname` AS `programfullname`,`d`.`id` AS `dept_id`,`d`.`name` AS `dept`,`ef`.`id` AS `form_id`,`sb`.`id` AS `subj_id`,`sb`.`name` AS `subj_name`,`sb`.`type` AS `sub_type`,`sb`.`credit_hour` AS `credit_hour`,`ml`.`status` AS `status`,`sb`.`course_code` AS `course_code`,`ef`.`type` AS `type`,'form_type' AS `form_type`,`ml`.`totalmark` AS `total_marks` from ((((((`marks_ledger` `ml` join `student` `std` on((`std`.`id` = `ml`.`std_id`))) join `subject` `sb` on((`sb`.`id` = `ml`.`sub_id`))) join `program` `p` on((`p`.`id` = `std`.`prog_id`))) join `dept` `d` on((`p`.`dept_id` = `d`.`id`))) join `semester` `sm` on((`sm`.`id` = `sb`.`sem_id`))) join `examform` `ef` on((`ef`.`id` = `ml`.`f_id`))) where (`ml`.`status` = 4) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mohsin`@`%` SQL SECURITY DEFINER VIEW `semmarksheet` AS select `getsubjmarks`.`std_id` AS `std_id`,`getsubjmarks`.`rollno` AS `rollno`,`getsubjmarks`.`fullname` AS `fullname`,`getsubjmarks`.`session` AS `session`,`getsubjmarks`.`semester` AS `semester`,(case when (`getsubjmarks`.`gender` = 1) then 'Mr.' else 'Miss.' end) AS `gen`,`getsubjmarks`.`dept_id` AS `dept_id`,(case when (`getsubjmarks`.`form_type` = 0) then 'Fresh' else 'Improver' end) AS `form_type`,`getsubjmarks`.`dept` AS `dept`,`getsubjmarks`.`status` AS `status`,`getsubjmarks`.`fathername` AS `fathername`,`getsubjmarks`.`prog_id` AS `prog_id`,`getsubjmarks`.`program` AS `program`,`getsubjmarks`.`programfullname` AS `programfullname`,`getsubjmarks`.`credit_hour` AS `credit_hour`,`getsubjmarks`.`course_code` AS `course_code`,`getsubjmarks`.`sem_id` AS `sem_id`,`getsubjmarks`.`form_id` AS `form_id`,`getsubjmarks`.`subj_id` AS `subj_id`,`getsubjmarks`.`subj_name` AS `subj_name`,`getsubjmarks`.`sub_type` AS `sub_type`,max(`getsubjmarks`.`total_marks`) AS `obt_marks`,(case when (`getsubjmarks`.`sub_type` = 0) then `findgp`(max(`getsubjmarks`.`total_marks`),100) else `findgp`(max(`getsubjmarks`.`total_marks`),50) end) AS `gp`,(case when (`getsubjmarks`.`sub_type` = 0) then `findgrade`(max(`getsubjmarks`.`total_marks`),100) else `findgrade`(max(`getsubjmarks`.`total_marks`),50) end) AS `grade`,(case when (`getsubjmarks`.`sub_type` = 0) then `findremarks`(max(`getsubjmarks`.`total_marks`),100) else `findremarks`(max(`getsubjmarks`.`total_marks`),50) end) AS `remarks` from `getsubjmarks` where (`getsubjmarks`.`status` = 4) group by `getsubjmarks`.`std_id`,`getsubjmarks`.`subj_id` */;
