...
(14,4,2021,3,2,0,'xyz','23412341234'),
(15,10,2021,5,0,2,'xyasdf','20123012031023'),
(16,10,2021,3,1,0,'324','343234');
...
insert  into `f_subject_teacher_assign`(`sub_id`,`t_id`,`session`,`incharge_id`,`date`) values 
(1,1,2021,1,'2'),
(2,2,2021,2,'2'),
(3,2,2021,3,'1'),
(6,2,2020,1,'1'),
(NULL,NULL,2021,NULL,'1618316791682'),
(NULL,NULL,2021,NULL,'1618316846463'),
(4,3,2021,NULL,'1618316938592'),
(4,3,2021,1,'1618317160609'),
(5,3,2021,1,'1618317404968'),
(NULL,NULL,2021,NULL,'1617975580417');
...
(10,'17-bscs-123','Usman',2,'Soomro',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`Aasim123`@`%` SQL SECURITY DEFINER VIEW `getsemesters` AS select `s`.`id` AS `sem_id`,`s`.`name` AS `Semester`,`p`.`id` AS `prog_id`,`p`.`name` AS `Program` from (`semester` `s` join `program` `p` on((`s`.`prog_id` = `p`.`id`))) */;
