...
(1,'Asadullah','bhatti',2,'asad','asad'),
...
(1,1,2020,1,1,3,NULL,NULL),
(2,1,2021,1,1,3,'','1618239984174'),
(4,1,2021,2,2,3,'','1618240127351'),
(5,4,2021,3,2,3,'xyz','23412341234'),
(6,9,2021,4,NULL,4,'','1618309073173'),
(7,9,2021,4,0,3,'','1617950338993'),
(8,9,2021,4,0,3,'','1617950344746'),
(9,9,2021,4,0,3,'','1617950478275'),
(10,9,2021,4,0,2,'','1617950487659'),
(11,9,2021,4,0,3,'','1617951724559'),
(12,9,2021,4,0,3,'','1617986405425'),
(13,9,2021,6,0,3,'','1617986786832'),
(14,9,2021,4,0,4,'','1617987132308'),
(15,9,2021,6,0,3,'','1617987193557'),
(16,9,2021,4,0,4,'','1617987229377'),
(17,9,2021,4,0,4,'','1617987522534'),
(18,9,2021,4,0,2,'','1617987575482'),
(19,9,2021,4,0,3,'','1617987778224'),
(20,10,2021,8,0,4,NULL,'4534525423'),
(21,9,2021,4,0,0,'','1618136631930'),
(22,9,2021,4,0,0,'','1618136863554'),
(23,9,2021,4,0,0,'','1618137013103');
...
/*Table structure for table `mark_ledger` */

DROP TABLE IF EXISTS `mark_ledger`;

CREATE TABLE `mark_ledger` (
  `id` int NOT NULL AUTO_INCREMENT,
  `std_id` int DEFAULT NULL,
  `sub_id` int DEFAULT NULL,
  `t_id` int DEFAULT NULL,
  ...
  KEY `t_id` (`t_id`),
  KEY `f_id` (`f_id`),
  CONSTRAINT `mark_ledger_ibfk_1` FOREIGN KEY (`std_id`) REFERENCES `student` (`id`),
  CONSTRAINT `mark_ledger_ibfk_2` FOREIGN KEY (`sub_id`) REFERENCES `subject` (`id`),
  CONSTRAINT `mark_ledger_ibfk_3` FOREIGN KEY (`t_id`) REFERENCES `teacher` (`id`),
  CONSTRAINT `mark_ledger_ibfk_4` FOREIGN KEY (`f_id`) REFERENCES `examform` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `mark_ledger` */

insert  into `mark_ledger`(`id`,`std_id`,`sub_id`,`t_id`,`f_id`,`mark`) values 
(1,1,1,1,1,100),
(2,10,10,6,20,60);
...
(7,'Shereen Fatima','Bhatti',2,'fatima','12345');
