...
(1,1,2,2,1,35,4,'1618653921511',8,35,60,'Approved By Controller'),
(2,1,2,2,1,20,4,'1618653982575',20,50,60,'Approved By Controller'),
(3,2,5,1,2,16,4,'1618654518034',14,16,60,'Approved By Controller'),
(4,1,5,1,2,15,4,'1618655199222',10,15,60,'Approved By Controller'),
(5,2,5,1,2,10,4,'1618655328381',9,13,60,'Approved By Controller'),
(6,1,5,1,2,7,4,'1618655386477',7,8,60,'Approved By Controller'),
(7,1,4,1,2,11,4,'1618655490801',8,10,60,'Approved By Controller'),
(8,1,3,1,1,11,4,'1618655570174',8,10,60,'Approved By Controller');
...
(3,2,3,'He wath update ',3),
(4,1,4,'updated marks',3),
(5,2,3,'jldafnsjldn',3);
...
/* Procedure structure for procedure `gazzated` */

/*!50003 DROP PROCEDURE IF EXISTS  `gazzated` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `gazzated`()
BEGIN
	select * from student;
	END */$$
DELIMITER ;
