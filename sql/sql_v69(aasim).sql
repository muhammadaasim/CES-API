...
(4,'Zulfiqar Ali','Rajpar',2,'zulfiqar','zulfiqar','12345-1234467-1','http://localhost:4000/uploads/navttc.jpg'),
(5,'wajahat','abro',6,'wajahat','wajahat','12345-1232567-1','http://localhost:4000/uploads/navttc.jpg');
...
(7,10,2021,231,0,3,NULL,'1620064997878','http://localhost:4000/uploads/navttc.jpg'),
(8,11,2021,239,0,3,NULL,'1620118094617','http://localhost:4000/uploads/navttc.jpg'),
(9,11,2021,240,0,3,NULL,'1620118116666','http://localhost:4000/uploads/navttc.jpg'),
(10,11,2021,241,0,3,NULL,'1620118128537','http://localhost:4000/uploads/navttc.jpg'),
(11,11,2021,242,0,3,NULL,'1620118141254','http://localhost:4000/uploads/navttc.jpg'),
(12,11,2021,243,0,3,NULL,'1620118155281','http://localhost:4000/uploads/navttc.jpg'),
(13,11,2021,244,0,3,NULL,'1620118187880','http://localhost:4000/uploads/navttc.jpg'),
(14,11,2021,245,0,3,NULL,'1620118204331','http://localhost:4000/uploads/navttc.jpg'),
(15,11,2021,246,0,3,NULL,'1620118228313','http://localhost:4000/uploads/navttc.jpg'),
(16,12,2021,239,0,3,NULL,'1620127354616','http://localhost:4000/uploads/navttc.jpg'),
(17,12,2021,240,0,3,NULL,'1620127380709','http://localhost:4000/uploads/navttc.jpg'),
(18,12,2021,241,0,3,NULL,'1620127392641','http://localhost:4000/uploads/navttc.jpg'),
(19,12,2021,242,0,3,NULL,'1620127405128','http://localhost:4000/uploads/navttc.jpg'),
(20,12,2021,243,0,3,NULL,'1620127415308','http://localhost:4000/uploads/navttc.jpg'),
(21,12,2021,244,0,3,NULL,'1620127425287','http://localhost:4000/uploads/navttc.jpg'),
(22,12,2021,245,0,3,NULL,'1620127435443','http://localhost:4000/uploads/navttc.jpg'),
(23,12,2021,246,0,3,NULL,'1620127446048','http://localhost:4000/uploads/navttc.jpg');
...
(29,7,2021,4,'1620063773617',33),
(30,7,2021,4,'1620063776039',34),
(32,7,2021,4,'1620063778551',35),
(31,7,2021,4,'1620063781907',36),
(33,7,2021,4,'1620063783529',37),
(35,8,2021,5,'1620120419901',62),
(36,8,2021,5,'1620120428990',63),
(37,8,2021,5,'1620120434594',64),
(38,8,2021,5,'1620120592185',65),
(39,8,2021,5,'1620120598499',66),
(40,8,2021,5,'1620120602075',67),
(41,8,2021,5,'1620120603532',68),
(43,8,2021,5,'1620120606644',69),
(44,8,2021,5,'1620120615816',70),
(42,8,2021,5,'1620120618152',71),
(45,8,2021,5,'1620120620117',72),
(47,8,2021,5,'1620120621917',73),
(48,8,2021,5,'1620120625420',74),
(46,8,2021,5,'1620120628552',75),
(50,8,2021,5,'1620120630590',76),
(49,8,2021,5,'1620120632566',77),
(52,8,2021,5,'1620120634315',78),
(51,8,2021,5,'1620120636144',79),
(51,8,2021,5,'1620120638040',80),
(51,8,2021,5,'1620120638184',81);
...
(17,9,12,5,6,20,4,'1619967139715',15,40,75,'Approved By Controller'),
(18,10,29,7,7,20,4,'1620065272843',20,40,80,'Approved By Controller'),
(19,10,30,7,7,20,4,'1620065282824',20,40,80,'Approved By Controller'),
(20,10,31,7,7,20,4,'1620065317268',20,20,60,'Approved By Controller'),
(21,11,35,8,8,20,4,'1620120690506',20,30,70,'Approved By Controller'),
(22,11,37,8,8,28,4,'1620120704186',19,40,87,'Approved By Controller'),
(23,11,36,8,8,20,4,'1620120716115',20,35,75,'Approved By Controller'),
(24,11,38,8,9,29,4,'1620120750697',18,40,87,'Approved By Controller'),
(25,11,39,8,9,29,4,'1620120792682',20,49,98,'Approved By Controller'),
(26,11,41,8,10,30,4,'1620120848065',20,40,90,'Approved By Controller'),
(27,11,52,8,15,30,4,'1620120860932',20,40,90,'Approved By Controller'),
(28,11,51,8,15,20,4,'1620120872221',14,40,74,'Approved By Controller'),
(29,11,40,8,10,20,4,'1620120931999',19,30,69,'Approved By Controller'),
(30,11,51,8,15,20,4,'1620120945614',20,46,86,'Approved By Controller'),
(31,11,51,8,15,20,4,'1620120947637',20,46,86,'Approved By Controller'),
(32,11,51,8,15,20,4,'1620120947663',20,46,86,'Approved By Controller'),
(33,11,42,8,11,20,4,'1620121103828',20,40,80,'Approved By Controller'),
(34,11,45,8,12,15,4,'1620121117945',15,40,70,'Approved By Controller'),
(35,11,46,8,13,10,4,'1620121130210',10,50,70,'Approved By Controller'),
(36,11,43,8,11,30,4,'1620121160347',20,20,70,'Approved By Controller'),
(37,11,44,8,12,20,4,'1620121180207',20,20,60,'Approved By Controller'),
(38,11,49,8,14,20,4,'1620121192605',20,33,73,'Approved By Controller'),
(39,11,50,8,14,20,4,'1620121213266',20,30,70,'Approved By Controller'),
(40,11,47,8,13,30,4,'1620121220750',20,20,70,'Approved By Controller'),
(41,11,48,8,13,20,4,'1620121241791',20,20,60,'Approved By Controller'),
(42,12,35,8,16,20,1,'1620127584473',20,30,70,''),
(43,12,36,8,16,30,1,'1620127594875',20,30,80,''),
(44,12,37,8,16,30,1,'1620127605801',20,40,90,''),
(45,12,38,8,17,20,1,'1620127615337',20,50,90,''),
(46,12,39,8,17,25,1,'1620127624879',20,30,75,''),
(47,12,40,8,18,20,1,'1620127641183',20,20,60,''),
(48,12,41,8,18,20,1,'1620127655041',20,40,80,''),
(49,12,43,8,19,20,1,'1620127663300',20,40,80,''),
(50,12,44,8,20,20,1,'1620127671787',20,40,80,''),
(51,12,42,8,19,30,1,'1620127683759',10,20,60,''),
(52,12,45,8,20,24,1,'1620127695658',19,40,83,''),
(53,12,47,8,21,30,1,'1620127709372',20,40,90,''),
(54,12,48,8,21,30,1,'1620127719275',20,50,100,''),
(55,12,46,8,21,30,1,'1620127729107',20,40,90,''),
(56,12,50,8,22,20,1,'1620127737772',20,50,90,''),
(57,12,49,8,22,30,1,'1620127747723',20,45,95,''),
(58,12,51,8,23,20,1,'1620127757885',20,43,83,''),
(59,12,52,8,23,30,1,'1620127792170',20,30,80,'');
...
(1,'BS-IT-004','Mohsin',3,11,'Soomro','1998-02-01','Islam',1,'Pakistan','mohsin','mohsin','shikarpur','Near Jamal Shah muhala ','Abdul qadeer','1619415713022',0,'http://localhost:4000/uploads/download.jpg'),
(2,'BS-IT-005','Madiha',3,10,'Arain','1998-03-30','Islam',2,'Pakistan','madiha','madiha','shikarpur','near','Ghulam murtaza','1619418429559',0,'http://localhost:4000/uploads/download.jpg'),
(3,'BS-ED-001','A',4,2,'A','2005-10-29','Islam',1,'Pakistan','aa','aa','Shikarpur','A','A','1619426190008',0,'http://localhost:4000/uploads/download.jpg'),
...
(8,'17-BSCS-10','Usman Soomro',1,26,'Soomro','19-22-22','islam',1,'pakistan','usman','usman','shikarpur','shikarpur','khalid','21312313123123\\',0,NULL),
(9,'17-bseng-11','saleem ahmed',5,183,'soomro','2222-02-22','islam',1,'pakistani','saleem','saleem','shikarpur','asdfasdfasdfa\nsdfasdf\nasdf\nasdf\n','abdul sallam','1619958421656',0,'http://localhost:4000/uploads/navttc.jpg'),
(10,'17-bscom-2020','Yasir',6,232,'Bhutto','2222-11-11','Islam',1,'Pakistan','yasir','yasir','Shikarpur','Shikarpur','Nasir','1620063481833',0,'http://localhost:4000/uploads/navttc.jpg'),
(11,'21-BSPHY-1','yameen',9,239,'sheikh','0022-02-22','Islam',1,'Pakistan','yameen','yameen','shikarpur','asdfa','jameel','1620117503527',0,'http://localhost:4000/uploads/navttc.jpg'),
(12,'21-BSPHY-2','Farhan',9,239,'syed','2222-02-22','islam',1,'pakistan','farhan','farhan','shikarpur','asfasdf','xyz','1620127325319',0,'http://localhost:4000/uploads/navttc.jpg');
...
(29,'Intrduction to Commerce',3,'xyz',231,0,1),
(30,'ITC ',3,'1.2',231,0,1),
(31,'English',3,'1.3',231,0,1),
(32,'Organizational Behaviour',3,'2.1',232,0,1),
(33,'English 2',3,'1.2',232,0,1),
(34,'OB -2',3,'3.1',233,0,0),
(35,'Introduction to Physics',3,'1.1',239,0,1),
(36,'Geology',3,'1.2',239,0,1),
(37,'Geography',3,'1.2',239,0,1),
(38,'Anotomy',3,'1.2',240,0,1),
(39,'Maths',3,'1.2',240,0,1),
(40,'calculus',3,'1.2',241,0,1),
(41,'Chemistry',3,'1.2',241,0,1),
(42,'Physiology',3,'1.3',242,0,1),
(43,'XYz',3,'1.3',242,0,1),
(44,'asdfa',3,'1.3',243,0,1),
(45,'ZYX',3,'1.3',243,0,1),
(46,'XYZ',3,'1.3',244,0,1),
(47,'NLM',3,'1.3',244,0,1),
(48,'XZM',3,'1.3',244,0,1),
(49,'YTM',3,'1.3',245,0,1),
(50,'XTZ',3,'1.3',245,0,1),
(51,'YLA',3,'1.3',246,0,1),
(52,'YLB',3,'1.3',246,0,1);
...
(7,'Shafiq','Syed',2,'shafiq','shafiq','12345-1234560-1',NULL,0,'http://localhost:4000/uploads/navttc.jpg'),
(8,'nasir','soomro',6,'nasir','nasir','12345-1234522-1',NULL,0,'http://localhost:4000/uploads/navttc.jpg');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mohsin`@`%` SQL SECURITY DEFINER VIEW `getpassedstudent` AS select `getgazzated`.`id` AS `id`,`getgazzated`.`dept_id` AS `dept_id`,`getgazzated`.`dept` AS `dept`,`getgazzated`.`prog_id` AS `prog_id`,`getgazzated`.`program` AS `program`,`getgazzated`.`sem_id` AS `sem_id`,count(`getgazzated`.`sem_id`) AS `sem_qty`,`getgazzated`.`std_id` AS `std_id`,`getgazzated`.`rollno` AS `rollno`,`getgazzated`.`student_name` AS `student_name`,`getgazzated`.`father_name` AS `father_name`,avg(`getgazzated`.`gpa`) AS `avg(gpa)`,`getgazzated`.`remarks` AS `remarks` from `getgazzated` where (`getgazzated`.`remarks` = 'pass') group by `getgazzated`.`dept`,`getgazzated`.`program`,`getgazzated`.`std_id` having (count(`getgazzated`.`sem_id`) > 7) */;
