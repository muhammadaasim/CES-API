...
insert  into `f_subject_teacher_assign`(`sub_id`,`t_id`,`session`,`sem_id`,`incharge_id`,`date`) values 
(1,1,2021,1,1,'2'),
(2,2,2021,1,2,'2'),
(3,2,2021,1,3,'1'),
(6,2,2020,2,1,'1'),
(NULL,NULL,2021,NULL,NULL,'1618316791682'),
(NULL,NULL,2021,NULL,NULL,'1618316846463'),
(4,3,2021,3,NULL,'1618316938592'),
(4,3,2021,3,1,'1618317160609'),
(5,3,2021,1,1,'1618317404968');
