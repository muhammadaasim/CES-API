...
(1,1,2021,1,0,4,'','1618203871631',1),
(2,2,2021,1,0,4,'','1618203919233',1),
(3,3,2021,1,0,4,'','1618204285799',1),
(4,4,2021,9,0,4,'','1618204679024',0),
(5,7,2021,1,0,4,'rejected','1618209547148',1),
(6,8,2021,1,0,4,'','1618217694548',1),
(7,9,2021,9,0,4,'','1618218762435',0);
...
(2,1,1,2,1,30,4,NULL,20,40,88,'rejected'),
(3,1,3,3,1,30,0,NULL,15,44,88,NULL),
(4,1,4,3,1,30,0,NULL,13,33,77,NULL),
(5,3,4,2,2,30,4,'1618304971221',20,40,90,'rejected'),
(6,4,5,2,2,30,4,'1618306540157',20,30,80,NULL),
(7,4,5,2,2,30,4,'1618306701805',10,20,60,NULL),
(80,1,2,1,1,30,0,NULL,17,44,NULL,NULL),
(81,8,2,2,6,13,4,'1618310859126',8,22,43,NULL),
(82,7,2,2,5,18,4,'1618310889378',15,20,53,NULL),
(83,3,2,2,3,8,4,'1618310908762',5,10,23,NULL),
(84,2,2,2,2,8,3,'1618310922237',5,8,21,NULL);
...
(1,'17-BSIT-004','Mohsin Ali',1,'Soomro','12-12-2012','Islam',1,'Pakistan','mohsin','mohsin','Shikarpur','Near khabar nahe','Abdul Qadeer','2141241442',0,NULL),
(2,'2','zohaib',2,'xyz','2/2/2020','islam',1,'pakistan','zohaib','zohaib','shikarpur','lakhi','khbr naahy','12313131',0,NULL),
(3,'17-BSIT-010','Muhammad Asim',1,'Soomro','12-12-2012','Islsm',1,'Pakistan','asim','asim','Shikarpur','Near Khabar nahe','Khabar nahe','123234224',0,NULL),
(4,'Farhan','Farhan Ali',2,'Syed','12-12-2012','Islam',1,'Pakistan','farhan','farhan','Shikarpur','Near Khabar nahe','Khabar nahe','4143434423',0,NULL),
(5,'17-BSIT-002','Amina waqar',NULL,'soomor','2007-04-03','Islam',2,'Pakistan','amina','amina','Shikarpur','Khabr ','Waqar ahmed','1618208794450',1,NULL),
(6,'BS-IT-005','shiraz ali shah',1,'Syed','2012-01-30','Islam',1,'Pakistan','shiraz','shiraz','Shikarpur','Near kal ','Khabar nahe','1618209079579',0,NULL),
(7,'BS-IT-006','Mudasir',1,'syed','2010-02-02','Islam',1,'Pakistan','mudasir','mudasir','Shikarpur','sfsdfs','Khabar nahe','1618209406521',0,NULL),
(8,'BS-IT-008','Kami',1,'Mirani','2011-01-29','Islam',1,'Pakistan','kami','kami','Shikarpur','shikarpur','Waqar','1618217663029',0,NULL),
(9,'21-CS-004','Asadullah ',2,'Bhatti','1987-09-25','Islam',1,'Pakistan','asadullah','asadullah','Rohri','Sukkur ','Abdullah','1618218561799',0,NULL),
(10,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','lsjfsl','dfsf','sdljsd','sldfj','asfjdl','1618513017442',0,'http://localhost:4000/uploads/[object Object]'),
(11,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','lsjfsl','dfsf','sdljsd','sldfj','asfjdl','1618513019364',0,'http://localhost:4000/uploads/[object Object]'),
(12,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','mohsin','mohsin','sdljsd','sldfj','asfjdl','1618513528672',0,'http://localhost:4000/uploads/[object Object]'),
(13,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','mohsin','mohsin','sdljsd','sldfj','asfjdl','1618513668176',0,'http://localhost:4000/uploads/[object Object]'),
(14,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','mohsin','mohsin','sdljsd','sldfj','asfjdl','1618514018675',0,'http://localhost:4000/uploads/undefined'),
(15,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','mohsin','mohsin','sdljsd','sldfj','asfjdl','1618514397928',0,'http://localhost:4000/uploads/[object Object]'),
(16,'123132','ljsfdn',1,'sldgjdlg','fdjasalfdk','sdggsg',1,'pakis','mohsin','mohsin','sdljsd','sldfj','asfjdl','1618514421103',0,'http://localhost:4000/uploads/student.png');
...
(2,'Elementry Math',3,'BSIT-1',1,0,1),
(3,'PF (TH)',3,'BSIT-1',1,0,0),
(4,'PF (PR)',1,'BSIT-1',1,1,1),
(5,'ITC (TH)',3,'BSCS-1',9,0,0),
(6,'Elementry Math',3,'BSCS-1',9,0,0),
(7,'PF (TH)',3,'BSCS-1',9,0,0),
(8,'PF (PR)',1,'BSCS-1',9,1,0);
...
insert  into `teacher`(`id`,`fullname`,`surname`,`dept_id`,`username`,`password`,`CNIC`,`date`,`isdisabled`) values 
(1,'Naveed Ali','Abro',1,'naveed','naveed','2342424124123',NULL,NULL),
(2,'Sheeren Fatima','Bhatti',1,'fatima','fatima','121231231231',NULL,NULL),
(3,'Saddam Hussain','Teewio',1,'teewno','teewno','43301-1345601-5',NULL,NULL);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`mohsin`@`%` SQL SECURITY DEFINER VIEW `getteacher` AS select `t`.`id` AS `id`,`t`.`fullname` AS `teacher_name`,`t`.`surname` AS `surname`,`t`.`dept_id` AS `dept_id`,`d`.`name` AS `dept_name`,`t`.`isdisabled` AS `isdisabled` from (`teacher` `t` join `dept` `d` on((`d`.`id` = `t`.`dept_id`))) */;
