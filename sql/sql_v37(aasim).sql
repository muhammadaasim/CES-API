...
insert  into `f_subject_teacher_assign`(`sub_id`,`t_id`,`session`,`incharge_id`,`date`,`id`,`isdisabled`) values 
(NULL,NULL,2021,NULL,'1618214968262',1,1),
(NULL,NULL,2021,NULL,'1618215039275',2,0),
(2,2,2021,1,'1618215097697',3,1),
(1,1,2021,1,'1618218022468',4,0);
...
insert  into `student`(`id`,`rollno`,`fullname`,`prog_id`,`caste`,`dateofbirth`,`religion`,`gender`,`nationality`,`username`,`password`,`district`,`address`,`fathername`,`insertiondate`,`isdisabled`) values 
(1,'17-BSIT-004','Mohsin Ali',1,'Soomro','12-12-2012','Islam',1,'Pakistan','mohsin','mohsin','Shikarpur','Near khabar nahe','Abdul Qadeer','2141241442',0),
(2,'2','zohaib',2,'xyz','2/2/2020','islam',1,'pakistan','zohaib','zohaib','shikarpur','lakhi','khbr naahy','12313131',0),
(3,'17-BSIT-010','Muhammad Asim',1,'Soomro','12-12-2012','Islsm',1,'Pakistan','asim','asim','Shikarpur','Near Khabar nahe','Khabar nahe','123234224',0),
(4,'Farhan','Farhan Ali',2,'Syed','12-12-2012','Islam',1,'Pakistan','farhan','farhan','Shikarpur','Near Khabar nahe','Khabar nahe','4143434423',0),
(5,'17-BSIT-002','Amina waqar',NULL,'soomor','2007-04-03','Islam',2,'Pakistan','amina','amina','Shikarpur','Khabr ','Waqar ahmed','1618208794450',1),
(6,'BS-IT-005','shiraz ali shah',1,'Syed','2012-01-30','Islam',1,'Pakistan','shiraz','shiraz','Shikarpur','Near kal ','Khabar nahe','1618209079579',0),
(7,'BS-IT-006','Mudasir',1,'syed','2010-02-02','Islam',1,'Pakistan','mudasir','mudasir','Shikarpur','sfsdfs','Khabar nahe','1618209406521',0),
(8,'BS-IT-008','Kami',1,'Mirani','2011-01-29','Islam',1,'Pakistan','kami','kami','Shikarpur','shikarpur','Waqar','1618217663029',0),
(9,'21-CS-004','Asadullah ',2,'Bhatti','1987-09-25','Islam',1,'Pakistan','asadullah','asadullah','Rohri','Sukkur ','Abdullah','1618218561799',0);
...
(1,'Naveed Ali','Abro',1,'naveed','naveed','2342424124123',NULL,0),
(2,'Sheeren Fatima','Bhatti',1,'fatima','fatima','121231231231',NULL,0),
(3,'Saddam Hussain','Teewio',1,'teewno','teewno','43301-1345601-5',NULL,0);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `getsubjbydept` AS select `s`.`id` AS `id`,`s`.`name` AS `Subj_Name`,`sm`.`id` AS `Sem_id`,`sm`.`name` AS `Sem_Name`,`p`.`id` AS `program_id`,`p`.`name` AS `program_name`,`p`.`dept_id` AS `dept_id`,`fsta`.`isdisabled` AS `isdisabled` from (((`subject` `s` join `semester` `sm` on((`sm`.`id` = `s`.`sem_id`))) join `program` `p` on((`s`.`sem_id` = `p`.`id`))) join `f_subject_teacher_assign` `fsta` on((`fsta`.`sub_id` = `s`.`id`))) */;
